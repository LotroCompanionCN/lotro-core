...
public final class ItemSaxParser extends DefaultHandler
{
  ...
  private int handleItemAttributes(Attributes attributes)
  {
    ...
    {
      EquipmentLocation slot=EquipmentLocation.getByKey(precludedSlotsStr);
    ...
    // Scaling
    String scalingStr=attributes.getValue(ItemXMLConstants.ITEM_SCALING_ATTR);
    if (scalingStr!=null)
    {
      ScalingData scaling=ScalingData.fromString(scalingStr);
